                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-quantity">
                                            <div class="quantity buttons_added">
                                                <a href="{{url("cart/add?product_id=$item->id&minus=1")}}"><input type="button" class="minus" value="-"></a>
                                                <input type="number" size="4" class="input-text qty text" title="Qty"
                                                       value={{$item->qty}} min="0" step="1">
                                                <a href="{{url("cart/add?product_id=$item->id&add=1")}}"><input type="button" class="plus" value="+"></a>
                                            </div>
                                        </td>
